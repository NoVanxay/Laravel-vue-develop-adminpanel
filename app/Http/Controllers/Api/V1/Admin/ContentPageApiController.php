...
class ContentPageApiController extends Controller
{
    public function index()
    {
        ...
        return new ContentPageResource(ContentPage::with(['users', 'category', 'tag'])->advancedFilter());
    }
    ...
    public function create(ContentPage $contentPage)
    {
    ...
    public function show(ContentPage $contentPage)
    {
        ...
        return new ContentPageResource($contentPage->load(['users', 'category', 'tag']));
    }
