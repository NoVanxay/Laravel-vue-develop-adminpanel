                    ...
                    _c("tbody", [
                      ...
                      _c("tr", [
                        _c("td", { staticClass: "text-primary" }, [
                          _vm._v(
                            "\n                        " +
                              _vm._s(_vm.$t("cruds.comment.fields.users")) +
                              "\n                      "
                          )
                        ]),
                        _vm._v(" "),
                      ...
                      _c("tr", [
                        _c("td", { staticClass: "text-primary" }, [
                          _vm._v(
                            "\n                        " +
                              _vm._s(_vm.$t("cruds.comment.fields.title")) +
                              "\n                      "
                          )
                        ]),
                        _vm._v(" "),
                        _c(
                          ...
                          [
                            _c("datatable-single", {
                              attrs: { row: _vm.entry, field: "title.title" }
                            })
                          ],
                          1
                        )
                      ...
                      _c("tr", [
                        _c("td", { staticClass: "text-primary" }, [
                          _vm._v(
                            "\n                        " +
                              _vm._s(_vm.$t("cruds.comment.fields.at")) +
                              "\n                      "
                          )
                        ]),
                        _vm._v(" "),
